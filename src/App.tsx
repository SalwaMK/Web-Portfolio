...
function ModalContent({ section }: { section: Section }) {
  ...
  if (section === "writing") return <><p className="eyebrow">KNOWLEDGE DROP / MEDIUM + RESEARCH</p><h2>ARTICLES & PRE-PRINTS</h2><p>Technical notes, practical AI lessons, behind-the-scenes build logs, and pre-publication research.</p><div className="writing-grid"><article><b>✎ MEDIUM ARTICLES</b><span>Insights from AI, data, and software engineering quests.</span><a className="big-link" href="https://medium.com/@salwamk" target="_blank" rel="noreferrer">OPEN MEDIUM ↗</a></article><article><b>≡ PRE-PRINTS</b><span>Research and experiments.</span><a className="big-link" href="https://www.researchsquare.com/article/rs-9847041/v1" target="_blank" rel="noreferrer">PRE-PRINT 01 ↗</a><a className="big-link" href="https://www.researchsquare.com/article/rs-10250790/v1" target="_blank" rel="noreferrer">PRE-PRINT 02 ↗</a></article></div></>;
  return <>
