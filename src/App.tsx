...
function ModalContent({ section }: { section: Section }) {
  ...
  return <>
    <p className="eyebrow">TRANSMISSION CHANNEL / OPEN</p><h2>LET’S CONNECT!</h2><p>Have a video idea or want to discuss tech, AI research, or a project collaboration? Reach out — I’d love to talk.</p>
    <div className="contact-options"><a href="mailto:salwamekni8@gmail.com">✉ salwamekni8@gmail.com</a><a href="https://linkedin.com/in/salwa-makni" target="_blank" rel="noreferrer">in /salwa-makni</a><a href="https://github.com/SalwaMK" target="_blank" rel="noreferrer">◒ @SalwaMK</a><a href="https://medium.com/@salwamk" target="_blank" rel="noreferrer">✎ @salwamk</a><a href="https://www.youtube.com/@salwa_mekni" target="_blank" rel="noreferrer">▶ @salwa_mekni</a></div>
